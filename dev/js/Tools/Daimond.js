...
class Daimond {
    ...
    drawDaimond(e) {
        window.requestAnimationFrame(() => {
            ...
            this.context.beginPath();
            this.context.moveTo(this.startPoint.x, this.startPoint.y + ((this.getMouseVerticalPosition(e) - this.startPoint.y) / 2));
            this.context.lineTo(this.startPoint.x + ((this.getMouseHorizontalPosition(e) - this.startPoint.x) / 2), this.getMouseVerticalPosition(e));
            this.context.stroke();
            // right - top
            this.context.beginPath();
            this.context.moveTo(this.startPoint.x + ((this.getMouseHorizontalPosition(e) - this.startPoint.x) / 2), this.startPoint.y);
